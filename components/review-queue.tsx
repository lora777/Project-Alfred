...
import { reviewQueue } from "@/data/mock-data";
import { Button } from "@/components/ui/button";
import { Card } from "@/components/ui/card";
import { SectionHeading } from "@/components/section-heading";

const classifications = ["Bruce", "Coyote", "Raccoon", "Unknown"] as const;
  ...
  return (
    <section>
      ...
      <Card className="divide-y divide-zinc-800/80 overflow-hidden">
        {reviewQueue.map((event, index) => {
          const classification = reviewed[event.id];
          return (
